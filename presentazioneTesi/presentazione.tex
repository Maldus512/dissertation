...
\begin{frame}[fragile]
    ...
    \begin{comment}
        ...
        Idealmente gli studenti dovrebbero implementare questi concetti; non e'
        immediato decidere con che grado di completezza e con quali strumenti a
        disposizione; quanto l'ambiente in cui lavorano debba essere semplificato
        e quali strumenti debbano essere forniti.
        Un esempio e' tanto piu' interessante quanto piu' e' aderente alla realta',
        ma la realta' porta con se' complicazioni estranee al programma del corso.
...
\begin{frame}[fragile]
    ...
    \begin{comment}
        ...
        sistema operativo per processori MIPSEL, soluzione applicata dal professor
        Davoli nel suo corso di Sistemi Operativi. 
        ...
        una maggiore concretezza, senza pero' perdere terreno in termini di chiarezza
        e coerenza degli argomenti trattati.
    \end{comment}
\end{frame}
...
\begin{frame}[fragile]
    ...
    \begin{comment}
        ...
        sono rilevanti per lo studio dei sistemi operativi. Per esempio, 
...
\begin{frame}[fragile]
    ...
    \begin{comment}
        ...
        reale.
        Essendo pensato per un target reale l'intero processo di sviluppo dovrebbe
        risultare meno astratto; per esempio, su uMPS 
        e' necessario un ulteriore passaggio, dopo la compilazione del kernel,
        per adattare il binario all'emulatore. Dopo aver linkato il proprio codice
        con MaldOS il risultato e' invece immediatamente pronto per essere caricato
        su un Raspberry Pi.
        ...
        cui il pieno supporto di GDB (tra cui anche l'esecuzione step-by-step).
        Infine ARMv8 e' una architettura moderna rispetto a MIPSEL.
    \end{comment}
\end{frame}
...
\begin{frame}[fragile]
    ...
    \begin{comment}
        ...
        Alcune periferiche sono troppo complesse e l'interazione deve essere semplificata,
        ma mai fornendo direttamente funzioni di alto livello; i comandi devono
        sempre essere indicati tramite registri, per non perdere la percezione 
        di avere a che fare con un processore.
        Come nell'immagine quindi alcune parti dell'hardware sono lasciate esposte
        e direttamente approcciabili. Altre, invece, vengono controllate passando
        attraverso il layer di MaldOS, che per questo e' "moderatamente astratto".
    \end{comment}
\end{frame}
